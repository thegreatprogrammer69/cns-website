...
const mobileHeroHeightClass = "min-h-[340px]";
const mobileHeroTopPaddingClass = "pt-[130px]";
...
function HeroContent() {
  return (
    <div
      className={`relative flex ${mobileHeroHeightClass} flex-col justify-end overflow-hidden px-4 pb-6 ${mobileHeroTopPaddingClass} sm:px-6 sm:pb-7 md:px-10 lg:min-h-0 lg:justify-center lg:overflow-visible lg:px-10 lg:py-8`}
    >
      ...
      <Image
        ...
        fill
        sizes="100vw"
        className="absolute inset-0 -z-20 object-cover object-top lg:hidden"
        priority
      />

      {/* Mobile fade overlay */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-transparent via-white/70 to-white lg:hidden" />
...
function HeroImage() {
  return (
    <div className="relative hidden h-[240px] overflow-hidden bg-amber-50 sm:h-[280px] md:h-[320px] lg:block lg:h-[390px]">
      <Image
        src="/kids-hero.png"
        alt="Дети собирают робота с преподавателем"
        fill
